    ...
    $('.tw-isotope-container').each(function () {
        ...
        if ($crGrid.length) {
            ...
            $('.tw-portfolio-filter li', $crCont).on('click', function () {
                ...
                var $button = $(this);
                $crGrid.isotope({
                    filter: $('span', $button).data('filter')
                });
        ...
        $tw_iso_conts.forEach(function ($crIsoCont) {
            ...
            if ($crType === 'masonry' && $crSlct) {
                $($crSlct, $crIsoCont).each(function () {
                    ...
                    $crIsoCont.isotope('reloadItems').isotope({
    ...
    $outs.each(function () {
        ...
        if ($sAcAnimTarget && $sAcAnimTarget.length && $sAcAnimOut) {
            $sAcAnimTarget.each(function (i) {
                var $delAnim = $(this).removeClass($sAcAnimOut).removeClass('tw-outview').css({
                    opacity: '',
                    visibility: ''
                });
                setTimeout(function () {
        ...
        if ($sAcAnimTarget && $sAcAnimTarget.length && $sAcAnimIn) {
            ...
            setTimeout(function () {
                $sAcAnimTarget.each(function (i) {
                    ...
                    setTimeout(function () {
                        $delAnim.removeClass('tw-outview').addClass($sAcAnimIn).css({
                            opacity: '',
                            visibility: ''
                        });
